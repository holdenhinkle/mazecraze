...
INSERT INTO settings (name, integer_value, updated_by) 
  VALUES
    ...
    ('simple_normal_squares_to_other_squares_ratio', .6, 'default setting'),

    
    ('bridge_x_min', 3, 'default setting'),
    ('bridge_x_max', 11, 'default setting'),
    ('bridge_y_min', 2, 'default setting'),
    ('bridge_y_max', 11, 'default setting'),
    ('bridge_endpoint_min', 1, 'default setting'),
    ('bridge_endpoint_max', 5, 'default setting'),
    ('bridge_barrier_min', 0, 'default setting'),
    ('bridge_barrier_max', 4, 'default setting'),
    ('bridge_bridge_min', 1, 'default setting'),
    ('bridge_bridge_max', 4, 'default setting'),
    ('bridge_normal_squares_to_other_squares_ratio', .6, 'default setting'),

    ('tunnel_x_min', 3, 'default setting'),
    ('tunnel_x_max', 12, 'default setting'),
    ('tunnel_y_min', 2, 'default setting'),
    ('tunnel_y_max', 12, 'default setting'),
    ('tunnel_endpoint_min', 1, 'default setting'),
    ('tunnel_endpoint_max', 6, 'default setting'),
    ('tunnel_barrier_min', 0, 'default setting'),
    ('tunnel_barrier_max', 5, 'default setting'),
    ('tunnel_tunnel_min', 1, 'default setting'),
    ('tunnel_tunnel_max', 5, 'default setting'),
    ('tunnel_normal_squares_to_other_squares_ratio', .6, 'default setting'),

    ('portal_x_min', 3, 'default setting'),
    ('portal_x_max', 13, 'default setting'),
    ('portal_y_min', 2, 'default setting'),
    ('portal_y_max', 13, 'default setting'),
    ('portal_endpoint_min', 1, 'default setting'),
    ('portal_endpoint_max', 7, 'default setting'),
    ('portal_barrier_min', 0, 'default setting'),
    ('portal_barrier_max', 6, 'default setting'),
    ('portal_portal_min', 1, 'default setting'),
    ('portal_portal_max', 6, 'default setting'),
    ('portal_normal_squares_to_other_squares_ratio', .6, 'default setting')
    ;